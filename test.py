...
# Parse the XML file
tree = ET.parse('Eng_context.lat.xml')
root = tree.getroot()
...
ax2.plot(Y[0:520], merged_df['Trend'][0:520], color=color)
ax2.plot(Y[520:530], merged_df['Trend'][520:530], color="yellow")
ax2.plot(Y[530:], merged_df['Trend'][530:], color=color)
