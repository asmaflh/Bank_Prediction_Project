...
fr = pd.read_csv('../../Sentiment_Youtube_Data/fr_comm.csv')
cn = pd.read_csv('../../Sentiment_Youtube_Data/ch_comm.csv')
de = pd.read_csv('../../Sentiment_Youtube_Data/de_comm.csv')
es = pd.read_csv('../../Sentiment_Youtube_Data/es_comm.csv')
it = pd.read_csv('../../Sentiment_Youtube_Data/it_comm.csv')
